...
async def strcall(client, message):
    assistant = await group_assistant(Gojo, message.chat.id)
    try:
        await assistant.join_group_call(message.chat.id, AudioPiped("./Gojo/assets/call.mp3"), stream_type=StreamType().pulse_stream)
